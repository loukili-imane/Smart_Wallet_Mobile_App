...
import com.example.SmartWallet_Project.transactions.activities.ListingCategoryTransactionsActivity;
...
public class BudgetCategoryListAdapter extends BaseAdapter
{
    ...
    public View getView(int i, View view, ViewGroup viewGroup)
    {
        ...
        currentExpenses.setText("MAD "+String.valueOf(budgetCategory.getCurrentBudget()));
        maxExpenses.setText("MAD "+String.valueOf(budgetCategory.getMaxBudget()));
