package com.example.SmartWallet_Project.mainactivity.fragments.home;
...
import com.example.SmartWallet_Project.budget_categories.BudgetCategory;
import com.example.SmartWallet_Project.budget_categories.BudgetCategoryManager;
import com.example.SmartWallet_Project.budget_categories.ui.BudgetCategoryListAdapter;
import com.example.SmartWallet_Project.transactions.activities.AddingTransactionActivity;
...
public class HomeFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        totalExpensesTextView.setText("MAD "+String.valueOf(BudgetCategoryManager.getTotalExpenses()));
